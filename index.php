...
function processSignup($conn) {
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["signupUsername"]) && isset($_POST["signupPassword"]) && isset($_POST["signupRole"])) {
        ...
        if ($conn->query($insertUserSql) === TRUE) {
            echo "<script>alert('Registration Success, Welcome, $username, please login');</script>";
        } else {
...
<div class="container mt-5">
    <div class="row">
        <div class="col-12 text-center">
            ...
            <h1 class="mt-4" style="color: white; font-weight: bolder; font-size:60px">Welcome to Employee Task Management</h1>
        ...
        <div class="modal-content" style="backdrop-filter: blur(10px);">
            ...
            <div class="modal-body">
                ...
                <form action="index.php" method="post">
                    <div class="mb-3">
                        <label for="loginUsername" class="form-label left-align" style="color: ;">Username</label>
                        <input type="text" class="form-control" id="loginUsername" name="loginUsername" placeholder="Enter your username" required>
                    </div>
                    <div class="mb-3">
                        <label for="loginPassword" class="form-label left-align" style="color: ;">Password</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" method="post">
                    <div class="mb-3">
                        <label for="signupUsername" class="form-label left-align">Username</label>
                        <input type="text" class="form-control" id="signupUsername" name="signupUsername" placeholder="Enter your username" required>
                    </div>
                    <div class="mb-3">
                        <label for="signupPassword" class="form-label left-align">Password</label>
                        <input type="password" class="form-control" id="signupPassword" name="signupPassword" placeholder="Enter your password" required>
                    </div>
                    <div class="mb-3">
                        <label for="signupRole" class="form-label left-align">Role</label>
                        <select class="form-select" id="signupRole" name="signupRole" placeholder="Select your role" required>
